...
export interface SessionsResponse {
    ...
    loginIp?: number;
    /**
     * @generated from protobuf field: string expires_on = 5;
     */
    expiresOn: string;
    /**
    ...
    isActive: boolean;
    /**
     * @generated from protobuf field: optional string logout_on = 8;
     */
    logoutOn?: string;
    /**
     * @generated from protobuf field: optional int32 logout_ip = 9;
     */
    logoutIp?: number;
}
/**
...
class SessionsResponse$Type extends MessageType<SessionsResponse> {
    constructor() {
        super("authentication.SessionsResponse", [
            ...
            { no: 5, name: "expires_on", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 6, name: "refresh_token", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 7, name: "is_active", kind: "scalar", T: 8 /*ScalarType.BOOL*/ },
            { no: 8, name: "logout_on", kind: "scalar", opt: true, T: 9 /*ScalarType.STRING*/ },
            { no: 9, name: "logout_ip", kind: "scalar", opt: true, T: 5 /*ScalarType.INT32*/ }
        ]);
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* bool is_active */ 7:
                    ...
                    break;
                case /* optional string logout_on */ 8:
                    message.logoutOn = reader.string();
                    break;
                case /* optional int32 logout_ip */ 9:
                    message.logoutIp = reader.int32();
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message: SessionsResponse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.expiresOn !== "")
            writer.tag(5, WireType.LengthDelimited).string(message.expiresOn);
        ...
        if (message.logoutOn !== undefined)
            writer.tag(8, WireType.LengthDelimited).string(message.logoutOn);
        /* optional int32 logout_ip = 9; */
        if (message.logoutIp !== undefined)
            writer.tag(9, WireType.Varint).int32(message.logoutIp);
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
